...
public class EditorBarHandler {
     ...
     * 加粗
     */
    @OnClick(cn.tomoya.android.md.R.id.btn_format_bold)
     ...
     * 倾斜
     */
    @OnClick(cn.tomoya.android.md.R.id.btn_format_italic)
     ...
     * 引用
     */
    @OnClick(cn.tomoya.android.md.R.id.btn_format_quote)
     ...
     * 无序列表
     */
    @OnClick(cn.tomoya.android.md.R.id.btn_format_list_bulleted)
     ...
     * 有序列表 FIXME 这里算法需要优化
     */
    @OnClick(cn.tomoya.android.md.R.id.btn_format_list_numbered)
     ...
     * 插入代码
     */
    @OnClick(cn.tomoya.android.md.R.id.btn_insert_code)
     ...
     * 插入链接
     */
    @OnClick(cn.tomoya.android.md.R.id.btn_insert_link)
    protected void onBtnInsertLinkClick() {
        AlertDialogUtils.createBuilderWithAutoTheme(activity)
                .setIcon(cn.tomoya.android.md.R.drawable.ic_insert_link_grey600_24dp)
                .setTitle(cn.tomoya.android.md.R.string.add_link)
                .setView(cn.tomoya.android.md.R.layout.dialog_tool_insert_link)
                .setPositiveButton(cn.tomoya.android.md.R.string.confirm, new DialogInterface.OnClickListener() {

                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        EditText edtTitle = ButterKnife.findById((Dialog) dialog, cn.tomoya.android.md.R.id.edt_title);
                        EditText edtLink = ButterKnife.findById((Dialog) dialog, cn.tomoya.android.md.R.id.edt_link);
     ...
     * 插入图片
     */
    @OnClick(cn.tomoya.android.md.R.id.btn_insert_photo)
     ...
     * 预览
     */
    @OnClick(cn.tomoya.android.md.R.id.btn_preview)
